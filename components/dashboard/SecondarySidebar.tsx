...
const menus: any = {
  'default': [
    ...
    { label: 'Analytics', href: '/dashboard/analytics', icon: <BarChart size={16} /> },
...
if (pathname.includes('/settings')) {
  ...
  // Hide secondary sidebar for Shop to give full width
  return null;
} else if (pathname.includes('/competitions')) {
  // Hide secondary sidebar for Competitions
  return null;
} else if (pathname.includes('/platforms')) {
  // Hide secondary sidebar for Platforms
  return null;
}
