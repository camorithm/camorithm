...
export const TopNav = ({ title = "Dashboard" }: { title?: string }) => {
return (
  <header className="h-20 flex items-center justify-between px-8 bg-white/80 dark:bg-[#0a0b0d]/80 backdrop-blur-md sticky top-0 z-30 border-b border-slate-200 dark:border-white/5">
